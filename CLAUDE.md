...
- **Free tier pricing hallucination** (2026-04-21). Sheli said "40 פעולות" free per month during live test. Actual free tier is 30 actions/month (and currently disabled via `BETA_MODE=true`). Minor drift in `SHARED_APP_RULES` or welcome prompts — worth auditing next time those are edited. Low urgency because paywall is off anyway.
