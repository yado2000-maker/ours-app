...
const CONTENT = {
  he: {
    ...
    freeBadge: "שלי מוסיפה מצטרפים חדשים בהדרגה · השאירו פרטים ונעדכן כשיגיע תורכם",
  ...
  en: {
    ...
    freeBadge: "Sheli is onboarding new signups in small batches \u00B7 Leave your details and we'll reach out when it's your turn",
